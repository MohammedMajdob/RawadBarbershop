    ...
    <div className="w-full bg-white">
      ...
      <div className="px-4 pt-3 pb-2">
        ...
        <div className="pl-[104px]">
          <h1 className="text-lg font-black text-gray-900">Gentlemen Barber Shop</h1>
        ...
        <div className="flex items-center justify-center gap-4 mt-3 pt-3 border-t border-gray-100">
          ...
          <div className="flex items-center gap-1.5 text-gray-500">
            ...
            <span className="text-sm font-semibold" dir="ltr">050-2763455</span>
          </div>
          <div className="w-px h-4 bg-gray-200" />
          <div className="flex items-center gap-1.5 text-gray-500">
            <span className="text-sm font-semibold">תספורת ₪70</span>
          </div>
        </div>
      </div>
    </div>
