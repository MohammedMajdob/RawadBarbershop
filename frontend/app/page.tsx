    ...
    <>
      ...
      {siteSettings?.announcementText && (
        <div className="max-w-3xl mx-auto w-full px-4 mt-2">
          <div className="flex items-center gap-2 bg-amber-50 border border-amber-200 rounded-xl px-4 py-2.5 text-right">
            <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <p className="text-sm font-medium text-amber-800 flex-1">{siteSettings.announcementText}</p>
          </div>
        </div>
      )}
